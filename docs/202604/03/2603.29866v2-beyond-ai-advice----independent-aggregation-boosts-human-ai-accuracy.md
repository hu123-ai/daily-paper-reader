...
date: 2026-03-31
pdf: "https://arxiv.org/pdf/2603.29866v2"
tags: ["query:q4"]
score: 6.0
evidence: 用于独立人类与AI判断聚合的混合确认树
tldr: 本研究针对传统“AI作为建议者”模式中人类难以区分AI建议对错且技能易退化的局限，提出了一种名为“混合确认树（HCT）”的新策略。HCT通过让AI与人类独立决策，在意见一致时直接采纳，不一致时引入第二名人类仲裁，从而保持判断的独立性。在医疗诊断、虚假信息识别等10个数据集上的实验表明，HCT的准确率全面优于传统模式，为提升人机协作效能提供了稳健且透明的新方案。
...
## 摘要
人工智能（AI）被广泛部署为人类决策者的顾问：AI 推荐一项决策，而人类选择接受或拒绝该建议。然而，这种方法存在若干局限性：人们经常忽略准确的建议，却过度依赖不准确的建议，且其决策技能可能会随时间推移而退化。在本文中，我们将“AI 作为顾问”的方法与混合确认树（HCT）进行了比较。HCT 是一种保留人类与 AI 判断独立性的替代策略。HCT 分别独立地获取人类判断和 AI 判断。如果两者一致，则采纳该决策；如果不一致，则由第二个人类进行裁决。为了进行比较，我们使用了来自医疗诊断和虚假信息识别等不同领域的 10 个数据集，以及其中 AI 还会解释其决策的 4 个数据集子集。在所有数据集中，HCT 的表现均优于“AI 作为顾问”的方法。在 AI 提供判断解释的几乎所有情况下，HCT 的表现也更好。利用信号检测理论解释这些结果，我们发现 HCT 优于“AI 作为顾问”的方法，是因为人们无法充分区分正确和错误的 AI 建议。总的来说，HCT 是“AI 作为顾问”方法的一种稳健、准确且透明的替代方案，为挖掘混合群体智慧提供了一种简单的机制。
