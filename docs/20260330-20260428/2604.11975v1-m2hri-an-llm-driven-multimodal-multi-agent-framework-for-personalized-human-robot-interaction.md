...
result: 用户研究表明，LLM驱动的性格特征具有高辨识度，长期记忆提升了偏好感知，而协调机制显著减少了交互重叠并提高了整体质量。
conclusion: 机器人的个体差异化和结构化协调是实现连贯、社交得体且高质量多机器人人机交互的关键要素。
---

## 摘要
多机器人系统在家庭和医院等社会环境中具有巨大潜力，但现有的多机器人研究通常将机器人视为功能相同的个体，忽视了机器人的个体身份如何塑造用户感知，以及在存在这种个体差异时，协调机制如何影响多机器人行为。为了解决这一问题，我们提出了 M2HRI，这是一个基于大语言模型构建的多模态多智能体框架，它为每个机器人赋予了独特的个性和长期记忆，并配备了基于这些差异的协调机制。在一项针对多智能体人机交互（HRI）场景的受控用户研究（n = 105）中，我们发现大语言模型驱动的性格特征具有显著的可辨识性并能提升交互质量，长期记忆改善了个性化和偏好感知，而中心化协调显著减少了行为重叠，同时提高了整体交互质量。总之，这些结果表明，智能体个性和结构化协调对于实现连贯且符合社交规范的多智能体人机交互至关重要。项目网站和代码可在 https://project-m2hri.github.io/ 获取。
