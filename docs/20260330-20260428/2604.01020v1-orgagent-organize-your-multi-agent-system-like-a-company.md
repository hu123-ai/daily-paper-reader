...
motivation: 旨在解决多智能体系统中如何有效组织多个智能体以提高复杂推理效率和降低成本的问题。
method: 提出OrgAgent框架，通过治理、执行和合规三个层级对多智能体协作进行结构化管理。
result: "实验显示层级化结构在多个任务中优于扁平化结构，如在SQuAD 2.0上性能提升102.73%且Token消耗减少74.52%。"
conclusion: 组织结构是影响多智能体推理效能、成本及协作行为的关键因素，层级化管理具有显著优势。
---
