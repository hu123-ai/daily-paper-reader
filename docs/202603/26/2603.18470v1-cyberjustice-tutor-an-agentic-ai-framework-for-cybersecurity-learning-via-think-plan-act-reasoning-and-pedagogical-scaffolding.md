...
tldr: 本研究针对刑事司法专业人员的网络安全教育，提出了CyberJustice Tutor框架。该系统采用“思考-计划-行动”认知循环，克服了传统聊天机器人的无状态和幻觉问题。通过结合维果茨基的最邻近发展区（ZPD）教学支架和自适应检索增强生成（RAG）技术，系统能根据学习者进度动态调整支持并确保内容准确。对123名参与者的研究验证了其在响应速度、易用性和准确性方面的高效性，证明了智能体AI在专业教育中的应用潜力。
selection_source: fresh_fetch
motivation: 传统大模型聊天机器人在高要求的法律和技术教育中存在无状态、易产生幻觉且缺乏教学引导的问题。
method: 提出一种基于智能体AI的框架，通过“思考-计划-行动”循环实现自主目标分解，并结合教学支架层与自适应RAG确保教学的个性化与准确性。
result: 包含执法人员在内的123名用户测试显示，系统在响应速度（4.7/5）、易用性（4.4/5）和准确性（4.3/5）方面均获得高度认可。
conclusion: 智能体AI架构能有效引导学习者完成个性化学习路径，是开展专业领域职业教育的可行且高效的方案。
---
